...
const Redirecting = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url(/forks.jpg)",
      }}
    >
      <div className=" flex flex-col items-start h-1/3 justify-center gap-1 my-20 pt-20">
        <h1
          className=" text-8xl font-bold text-stroke-1 m-1
        text-color1 fontpop-5"
        >
          Redirecting...
        </h1>
      </div>
