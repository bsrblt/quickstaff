...
const Card: React.FC<CardProps> = ({ textBig, textSmall, children }) => {
  return (
    <div className="max-w-[28.6rem] rounded-xl  antialiased duration-300 text-center sm:py-5 py-3 sm:px-5 px-2 dark:bg-gray-900 hover:fontpop-1 backdrop-blur-[20px] shadow-xl bg-white/30  ">
      {children}
