  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-center ">
      <section className="flex flex-col w-full h-screen bg-cover bg-fixed bg-center justify-start items-center">
        <ParallaxBackground imgSource="/i-9.jpg" />
        <div className="flex h-[50%] sm:my-[4rem] my-20 mx-2 justify-end items-end ">
          <MainTitle
            textBig={
              <h1 className="lg:text-9xl md:text-8xl sm:text-7xl text-7xl font-bold text-white  drop-shadow-xl sm:mt-10 mt-10 pt-10 fontpop-4">
                Just relax.
              </h1>
            }
            textSmall={
              <h1 className="md:text-5xl sm:text-4xl text-2xl font-bold text-white  drop-shadow-xl sm:mt-1 sm:pt-1 pl-[3px]  mb-20 fontpop-4  rounded-md">
