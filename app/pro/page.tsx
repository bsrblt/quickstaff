    ...
    <main className="flex flex-col min-h-screen items-center justify-center ">
      <section className="flex flex-col w-full h-screen bg-cover bg-fixed bg-center justify-start items-center">
        ...
        >
          <MainTitle
            textBig={
              <h1 className="text-white lg:text-[6rem] xl:text-[rem] md:text-7xl pt-[1rem] sm:text-6xl text-5xl mt-20 font-bold drop-shadow-xl fontpop-2">
                Do it <span className="text-bubblegum/90 fontpop-3 ">your</span>{" "}
                way.
              </h1>
            }
            textSmall={
              <h1 className="text-white lg:text-[2.5rem] md:text-3xl text-xl font-bold drop-shadow-xl  m-1 md:pb-[4rem] pb-[2.3rem] antialiased fontpop-2">
